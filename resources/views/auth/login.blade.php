...
<div class="container-fluid register-page my-5">
    ...
    <div class="d-flex justify-content-center mt-4"><a class="pl-1" href="{{ route('password.request') }}">
            ¿Has olvidado tu contraseña?</a></div>

    <div class="d-flex justify-content-center mt-4">¿Aun no tienes una cuenta? <a class="pl-1"
            href="{{ route('register') }}">
            Regístrate</a></div>
</div>
