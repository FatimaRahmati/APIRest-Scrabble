...
Route::get("/creditos", "PrinterHistoryController@index");
...
Route::prefix("scrabble")->group(function () {
    ...
    Route::get(
        "/block_auth",
        "Auth\RegisterController@showBlockAuthForms",
    )->name("blockauth");
    ...
    */
    ...
    Route::get("/game/{id}", "GameController@showTableboard")->name(
        "tableboard",
    );
